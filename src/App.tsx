...
const totalAnimationTime = CAKE_DESCENT_DURATION + TABLE_SLIDE_DURATION + 2;
...
const BACKGROUND_FADE_END = Math.max(
  CAKE_DESCENT_DURATION + TABLE_SLIDE_DURATION - BACKGROUND_FADE_OFFSET,
...
const BIRTHDAY_CARDS: ReadonlyArray<BirthdayCardConfig> = [
    ...
    },
    {
      id: "confetti-3",
      image: "/card3.png",
      position: [-1, 0.081, -1.5], // left front of cake
      rotation: [-Math.PI / 2, 0, -Math.PI / 6],
    },
  ];
    ...
    <div className="App">
      ...
      >
        <Suspense fallback={null}>
          ...
          <Fireworks isActive={true} origin={[0, 10, 0]} />
